...
INSERT INTO Sales (customer_id_num, item_code, sale_date, sale_time, quantity, sale_price) VALUES (
    (1, 'fnyns',    2023-01-01, 12.30.05,   2,  1.99),
    (2, 'bbblgm',   2023-01-01, 12.35.05,   1,  0.99),
    (3, 'lrgcff',   2023-01-01, 12.38.05,   1,  0.99),
    (4, 'chzt',     2023-01-01, 12.42.05,   1,  2.99),
    (5, 'hnyhm',    2023-01-01, 12.50.05,   2,  3.99),
    (6, '2ltrck',   2023-01-01, 12.53.05,   1,  1.99),
    (7, '',         2023-01-01, 12.30.05,   0,  0.00),
    (8, 'chctc',    2023-01-01, 13.02.05,   1,  1.99),
    (9, '2ltrck',   2023-01-01, 13.03.05,   2,  1.99),
    (10,'lrgcff',   2023-01-01, 13.05.05,   2,  0.99)
)
...
SELECT COUNT(*) AS number_customers FROM Customers GROUP BY gender;
